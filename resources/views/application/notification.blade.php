            ...
            <div class="notification-page-full mt-24">
                ...
                <div class="notification-page-sec">
                    ...
                    <div class="notification-content">
                        <p class="noti-title">Your Wing Chair from our store has been procedded.</p>
                        <p class="noti-subtitle mt-8">34 minutes ago</p>
                    </div>
                </div>
                <div class="notification-page-sec mt-16">
                    <div class="notification-img">
                        <img src="assets/images/notification/notification-2.png" alt="notification-img">
                    </div>
                    <div class="notification-content">
                        <p class="noti-title">Your have pickup Corner Chair in our shop.</p>
                        <p class="noti-subtitle mt-8">2 hours ago</p>
                    </div>
                </div>
                <div class="notification-page-sec mt-16">
                    <div class="notification-img">
                        <img src="assets/images/notification/notification-3.png" alt="notification-img">
                    </div>
                    <div class="notification-content">
                        <p class="noti-title">Don’t miss a 30% discount for king chair today</p>
                        <p class="noti-subtitle mt-8">4 hours ago</p>
                    </div>
                </div>
                <div class="notification-page-sec mt-16">
                    <div class="notification-img">
                        <img src="assets/images/notification/notification-4.png" alt="notification-img">
                    </div>
                    <div class="notification-content">
                        <p class="noti-title">Your Dream Bench from our store has ben processed</p>
                        <p class="noti-subtitle mt-8">7 hours ago</p>
                    </div>
                </div>
                <div class="notification-page-sec mt-16">
                    <div class="notification-img">
                        <img src="assets/images/notification/notification-5.png" alt="notification-img">
                    </div>
                    <div class="notification-content">
                        <p class="noti-title">Relax Chair has arrived at your destination</p>
                        <p class="noti-subtitle mt-8">A day ago</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="bottom-panel nagivation-menu-wrap">
                            <ul class="sc-bottom-bar furniture-bottom-nav" id="furniture_navbar">
                                ...
                                <li class="nav-menu-icon nav-account-icon">
                                    <a href="notification.html"  class="notification-icon navigation-icons left-icon active">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
