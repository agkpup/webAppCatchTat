...
<form class="payment-form-deatils mt-24">
    <div id="payment-section">
        <div class="container">
            <div class="payment-section-full">
                <h1 class="d-none">Payment Method</h1>
                <h2 class="d-none">Payment</h2>
                <div class="mt-24">
                    <p class="selc-pay-txt">Choose your payment method</p>
                </div>
                <div class="insta_type_wrap mt-24">
                    <a href="#apply-pay" class="apply-pay pay-btn active ">
                        <div class="payment-btn">
                            <div class="check-select-mode p-0">
                    ...
                    <a href="#paypal" class="paypal pay-btn">
                        <div class="payment-btn">
                            <div class="check-select-mode p-0">
                                <div class="payment-custom-radio">
                                    <svg width="23" height="28" viewBox="0 0 23 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M20.8028 7.52747C20.7787 7.68688 20.7507 7.84979 20.7196 8.0172C19.6447 13.6739 15.9671 15.6281 11.2704 15.6281H8.87897C8.30454 15.6281 7.82041 16.0555 7.73108 16.6363L6.15991 26.8512C6.10174 27.2327 6.38847 27.5762 6.76379 27.5762H11.0053C11.5075 27.5762 11.9342 27.2023 12.0133 26.6946L12.0549 26.4738L12.8535 21.2793L12.9049 20.9944C12.983 20.485 13.4106 20.1108 13.9128 20.1108H14.5471C18.6565 20.1108 21.8735 18.4008 22.8138 13.4521C23.2064 11.3849 23.0032 9.65878 21.9638 8.44481C21.6494 8.07882 21.2592 7.77495 20.8028 7.52747Z" fill="#298FC2"></path>
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M19.6779 7.068C19.5136 7.01886 19.3442 6.97445 19.1704 6.93428C18.9956 6.89511 18.8167 6.86044 18.6325 6.83C17.9877 6.72322 17.2811 6.67258 16.5243 6.67258H10.1357C9.97825 6.67258 9.8288 6.709 9.69517 6.77486C9.40041 6.92006 9.18159 7.20597 9.12853 7.55599L7.76937 16.3791L7.73042 16.6363C7.81975 16.0555 8.30388 15.6282 8.87831 15.6282H11.2697C15.9665 15.6282 19.644 13.673 20.7189 8.01728C20.751 7.84988 20.7781 7.68697 20.8022 7.52755C20.5303 7.37961 20.2358 7.25312 19.9186 7.14534C19.8402 7.11865 19.7594 7.09295 19.6779 7.068Z" fill="#22284F"></path>
                    ...
                    <a href="#master-pay" class="mastercard pay-btn">
                        <div class="payment-btn">
                            <div class="check-select-mode p-0">
                                <div class="payment-custom-radio">
                                    <svg width="47" height="28" viewBox="0 0 47 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M23.3685 24.3601C20.9307 26.3978 17.7686 27.6279 14.3132 27.6279C6.60315 27.6279 0.352936 21.5035 0.352936 13.9487C0.352936 6.3939 6.60315 0.269531 14.3132 0.269531C17.7686 0.269531 20.9307 1.49963 23.3685 3.5373C25.8062 1.49963 28.9684 0.269531 32.4238 0.269531C40.1338 0.269531 46.384 6.3939 46.384 13.9487C46.384 21.5035 40.1338 27.6279 32.4238 27.6279C28.9684 27.6279 25.8062 26.3978 23.3685 24.3601Z" fill="#ED0006"></path>
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M23.3685 24.3601C26.3701 21.8511 28.2734 18.1177 28.2734 13.9487C28.2734 9.7797 26.3701 6.0463 23.3685 3.53729C25.8062 1.49962 28.9684 0.269531 32.4237 0.269531C40.1338 0.269531 46.384 6.3939 46.384 13.9487C46.384 21.5035 40.1338 27.6279 32.4237 27.6279C28.9684 27.6279 25.8062 26.3978 23.3685 24.3601Z" fill="#F9A000"></path>
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M23.3685 24.36C26.3701 21.851 28.2734 18.1177 28.2734 13.9487C28.2734 9.77974 26.3701 6.04636 23.3685 3.53735C20.3669 6.04636 18.4636 9.77974 18.4636 13.9487C18.4636 18.1177 20.3669 21.851 23.3685 24.36Z" fill="#FF5E00"></path>
                                    </svg>
                                </div>
                            </div>
                        </div>
                    </a>
                    <a href="#pay" class="pay pay-btn">
                        <div class="payment-btn">
                            <div class="check-select-mode p-0">
                                <div class="payment-custom-radio">
    ...
    <div class="hero-heading">
        <div  id="apply-pay" class="apply-pay-sec">
            <div class="container">
                <div class="payment-method-bottom-full mt-24">
                    <h3 class="pay-txt1">Apple Pay</h3>
                    <div class="payment-form mt-16">
                        <input type="number" id="apple-id" class="custom-payment-input" placeholder="Enter Apple ID">
                    </div>
                    <div class="switch-sec mt-24">
                        <div>
                            <h4 class="pay-txt2">Save Information</h4>
                        </div>
                        <div>
                            <label class="switch">
        ...
        <div id="gpay" class="gpay-sec hello">
            <div class="container">
                <div class="payment-method-bottom mt-24">
                    <div class="payment-method-bottom-full">
                        <h3 class="pay-txt1">G Pay</h3>
                        <div class="payment-form mt-16">
                            <input type="number" id="UPI-id" class="custom-payment-input" placeholder="Enter UPI ID">
                        </div>
                        <div class="switch-sec mt-24">
                            <div>
                                <h4 class="pay-txt2">Save Information</h4>
        ...
        <div id="visa" class="visa-sec hello">
            <div class="container">
                <div class="payment-method-bottom-full mt-24">
                    <h3 class="pay-txt1">Visa Card</h3>
                    <div class="payment-form mt-16">
                        <input type="number" id="visa-number" class="custom-payment-input" placeholder="Enter Card Number">
                        <input type="text" id="visa-name" class="custom-payment-input mt-12" placeholder="Card Holder Name">
                        <div class="date-picker-sec mt-16">
                                    ...
                                    <div class="form-item">
                                        <ul class="input date-picker-input">
                                            <li class="input__list">
                                                <input type="text" class="input__item custom-payment-input" placeholder="DD/MM/YY" id="dp1686541449904">
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div>
                                <input type="number" id="visa-cvc" class="custom-payment-input" placeholder="CVC">
                            </div>
                        </div>
                    </div>
                    <div class="switch-sec mt-24">
        ...
        <div id="paypal" class="paypal-sec">
            <div class="payment-method-bottom-full mt-24">
                <div class="container">
                    <h3 class="pay-txt1">Paypal Information</h3>
                    <div class="payment-form mt-16">
                        <input type="email" id="paypal-id" class="custom-payment-input" placeholder="Enter Registered Email ">
                    </div>
                    <div class="switch-sec mt-24">
                        <div>
                            <h4 class="pay-txt2">Save Information</h4>
        ...
        <div  id="master-pay" class="apply-pay-sec">
            <div class="container">
                <div class="payment-method-bottom-full mt-24">
                    <h3 class="pay-txt1">Master Pay</h3>
                    <div class="payment-form mt-16">
                        <input type="number" id="master-id" class="custom-payment-input" placeholder="Enter Master ID">
                    </div>
                    <div class="switch-sec mt-24">
                        <div>
                            <h4 class="pay-txt2">Save Information</h4>
        ...
        <div id="pay" class="amazon-sec">
            <div class="payment-method-bottom-full mt-24">
                <div class="container">
                    <h3 class="pay-txt1">Amazon Pay Information</h3>
                    <div class="payment-form mt-16">
                        <input type="number" id="amzon-no" class="custom-payment-input" placeholder="Enter Registered Mobile Number  ">
                        <input type="number" id="amzon-id" class="custom-payment-input mt-8" placeholder="Enter Amazon Pay UPI">
                    </div>
                    <div class="switch-sec mt-24">
                        <div>
                            <h4 class="pay-txt2">Save Information</h4>
