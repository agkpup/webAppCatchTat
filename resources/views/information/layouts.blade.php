            ...
            <div class="th-mobile-menu">
                <ul>
                    ...
                    <li class="menu-item-has-children">
                        <a href="{{route('serviceOrder')}}">services</a>
                        <ul class="sub-menu">
                            <li><a href="{{route('pricing')}}">Pricing</a></li>
                            <li><a href="{{route('serviceInformation')}}">Our Services</a></li>
                    ...
                    <div class="row align-items-center justify-content-between">
                                ...
                                <ul>
                                    ...
                                    <li class="menu-item-has-children">
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li><a href="{{route('serviceInformation')}}">Our Services</a></li>
                                            <li><a href="{{route('serviceOrder')}}">Wash clothes</a></li>
                                            <li><a href="{{route('pricing')}}"></a> Pricing </li>
                                        </ul>
                                    </li>
                                    <li>
                                        <a href="{{route('contactUs')}}">Contact</a>
                        ...
                        <div class="col-auto d-none d-xl-block">
                            <div class="header-button">
                                ...
                                <a href="{{route('serviceOrder')}}" class="th-btn style4 th-radius">Schedule A Pickup</a>
                            </div>
                        </div>
                    </div>
                </div>
